...
M.telescope = {
  ...
  n = {
    ...
    ["<leader>ds"] = { "<cmd> Telescope lsp_document_symbols <CR>", "find symbols in document" },
    ["<leader>ws"] = { "<cmd> Telescope lsp_dynamic_workspace_symbols <CR>", "find symbols in workspace" },
